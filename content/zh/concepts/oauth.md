...
Anthropic 设置-token (subscription auth)
...
运行时 cache (managed automatically; don’t edit):
...
if
expires
is在the future → use the stored access token
